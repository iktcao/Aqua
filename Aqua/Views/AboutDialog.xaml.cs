...
namespace Aqua.Views
{
    ...
    public partial class AboutDialog : CustomDialog
    {
        public AboutDialog()
        {
            ...
            this.uriGithub = new Uri("https://github.com/iktcao/Aqua");
            this.uriEmail = new Uri("mailto:iktcao@gmail.com?subject=关于水和水蒸气性质计算程序的反馈&body=反馈如下:");
